                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.RegistredUserPayload"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.commentPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/feed": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search filter for the feed",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Field for sorting data",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Field for pagination limit",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Field for pagination offset",
                        "name": "offset",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Field for filtering by tags",
                        "name": "tags",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Field for filtering until a date",
                        "name": "since",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Field for filtering since a date",
                        "name": "until",
                        "in": "query"
                    }
                ],
